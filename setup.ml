...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c3ab54198d3231a949db194a46c6dbd) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$unittest", ["inline-test-runner"; "topology"]))
                   ];
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["https://github.com/frenetic-lang/ocaml-topology/contributors"];
          homepage = None;
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Network"; "Network_Common"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "topology"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "topology.ml"});
               Executable
                 ({
                     cs_name = "unittest";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "F\020/\188\029\210P\213\146\004\187K,o\242\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
