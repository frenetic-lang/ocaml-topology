...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2709aeef3911dfc41395a350368d8d43) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Topology"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Topology_Core"; "Topology_Util"; "Parsers"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "speed.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Íf\142¸±+ªã³(.\155»6\018è";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
